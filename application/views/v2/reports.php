...
endforeach; ?>
                <?php if (empty($recent_hostel)): ?>
                    <tr><td colspan="4" style="text-align: center; color: var(--text-muted);">No records found matching filters</td></tr>
                <?php
endif; ?>
            </tbody>
        </table>
...
?>
                <tr>
                    ...
                    <td>
                        <div style="font-weight: 900; color: var(--accent); font-size: 16px;"><?php echo $total; ?> <span style="font-size: 11px; color: var(--text-muted);">/ 100</span></div>
                    </td>
                </tr>
                <?php
endforeach; ?>
