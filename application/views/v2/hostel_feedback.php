        ...
        <div style="background: rgba(99, 102, 241, 0.03); padding: 20px; border-radius: 12px; margin-bottom: 25px; border: 1px dashed var(--accent-glow);">
            ...
            <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 15px;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" readonly value="<?php echo isset($cal) ? $cal->duration . ' Days' : ''; ?>" style="background: transparent; font-weight: 700;">
                </div>
            </div>
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="number" name="q<?php echo $i; ?>" class="form-control" style="text-align: center;" min="1" max="5" value="5" required></td>
                    </tr>
                    <?php endfor; ?>
                </tbody>
            </table>
